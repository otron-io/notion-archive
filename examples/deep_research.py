...
def main() -> None:
    ...
    parser.add_argument("--model", type=str, default="o4-mini-deep-research-2025-06-26", help="Deep Research model to use (see OpenAI docs)")
    ...
    report = archive.deep_research(args.query, top_k=args.top_k, model=args.model)
    print("\n================= RESEARCH REPORT =================\n")
    print(report)
